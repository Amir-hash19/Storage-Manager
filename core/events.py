...
class EventBus:
    ...
    _routes = {
        UserRegisteredEvent: (process_audit_event,),
        UserLoggedInEvent: (process_audit_event,),
        UserChangedPasswordEvent: (process_audit_event,),
        FileUploadRequestedEvent: (process_storage_event,),
        FileUploadedEvent: (process_audit_event,),
    }
