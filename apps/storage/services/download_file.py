...
class DownloadFileService:
    ...
    def execute(file_id, user):
        ...
        file = FileRepository.get_active_by_id(file_id=file_id, owner=user)
        ...
        stream = storage.download(storage_key=file.storage_key)

        response = FileResponse(stream, as_attachment=True, filename=file.file_name)
