...
class FileService:
    ...
    def get_file(*, owner, file_id):
        return FileRepository.get_active_by_id(owner=owner, file_id=file_id)
    ...
    def soft_delete(*, owner, file_id):
        ...
        file = FileRepository.get_active_by_id(owner=owner, file_id=file_id)
    ...
    def restore(*, owner, file_id):
        ...
        file = FileRepository.get_deleted_by_id(owner=owner, file_id=file_id)
